...
public:
    bool ToObject(QSqlQuery& query, PortfolioObject& obj, QHash<QString, MBP_Data_Struct> MBP_Data_Hash,QHash<QString, PortfolioAvgPrice> averagePriceList,double devicer_,int decimal_precision_)
    {
        ...
        try
        {
            ...
            obj.Leg1LotSizeOrg = ContractDetail::getInstance().GetLotSize(obj.Leg1TokenNo);
            obj.Leg2LotSize = ContractDetail::getInstance().GetLotSize(obj.Leg2TokenNo);
            obj.Leg3LotSize = ContractDetail::getInstance().GetLotSize(obj.Leg3TokenNo);
            obj.Leg4LotSize = ContractDetail::getInstance().GetLotSize(obj.Leg4TokenNo);
            obj.Leg5LotSize = ContractDetail::getInstance().GetLotSize(obj.Leg5TokenNo);
            obj.Leg6LotSize = ContractDetail::getInstance().GetLotSize(obj.Leg6TokenNo);
            ...
            obj.InstrumentName = ContractDetail::getInstance().GetInstrumentName(obj.GetFirstToken());
            ...
            obj.Expiry = ContractDetail::getInstance().GetExpiry(obj.GetFirstToken(), "dd-MMM-yy");
            obj.ExpiryMonth = ContractDetail::getInstance().GetExpiry(obj.GetFirstToken(), "MMM");
            obj.ExpiryDateTime = ContractDetail::getInstance().GetExpiryDate(obj.GetFirstToken());
            obj.ExpiryBinary = ContractDetail::getInstance().GetExpiry(obj.GetFirstToken());
            ...
            case PortfolioType::F2F:
                obj.Leg1 = ContractDetail::getInstance().GetExpiry(obj.Leg1TokenNo, "ddMMMyy");
                obj.Leg2 = ContractDetail::getInstance().GetExpiry(obj.Leg2TokenNo, "ddMMMyy");
                break;
            ...
            case PortfolioType::BS1221:
            {
                ...
                obj.Leg3 = ContractDetail::getInstance().GetStrikePrice(obj.Leg3TokenNo);
                obj.AdditionalData1 = query.value("AdditionalData1").toString();//Convert.ToString(reader["AdditionalData1"]);
                obj.Leg3 = ContractDetail::getInstance().GetStrikePrice(obj.Leg5TokenNo)+query.value("AdditionalData1").toString();

                break;
            }

            case PortfolioType::CR:
                obj.Expiry = ContractDetail::getInstance().GetExpiry(obj.Leg2TokenNo, "dd-MMM-yy");
                obj.ExpiryDateTime = ContractDetail::getInstance().GetExpiryDate(obj.Leg2TokenNo);
                obj.ExpiryBinary = ContractDetail::getInstance().GetExpiry(obj.Leg2TokenNo);
            ...
            case PortfolioType::JBX:
                obj.Leg1 = ContractDetail::getInstance().GetStrikePrice(obj.Leg1TokenNo);
                obj.Leg2 = ContractDetail::getInstance().GetStrikePrice(obj.Leg3TokenNo);
            ...
            case PortfolioType::JBX_3L:
                if (obj.Leg1TokenNo == 0)
                {
                    ...
                    obj.Leg1 = (ContractDetail::getInstance().GetStrikePrice(obj.Leg2TokenNo))+(query.value("AdditionalData2").toString());
                    obj.Leg2 = (ContractDetail::getInstance().GetStrikePrice(obj.Leg3TokenNo))+(query.value("AdditionalData1").toString());
                    obj.Leg3 = (ContractDetail::getInstance().GetStrikePrice(obj.Leg4TokenNo))+(query.value("AdditionalData2").toString());

                }
                else if (obj.Leg2TokenNo == 0)
                {
                    obj.Leg1 = (ContractDetail::getInstance().GetStrikePrice(obj.Leg1TokenNo))+(query.value("AdditionalData1").toString());
                    obj.Leg2 = (ContractDetail::getInstance().GetStrikePrice(obj.Leg3TokenNo))+(query.value("AdditionalData1").toString());
                    obj.Leg3 = (ContractDetail::getInstance().GetStrikePrice(obj.Leg4TokenNo))+(query.value("AdditionalData2").toString());
                }
                ...
                {
                    obj.Leg1 = (ContractDetail::getInstance().GetStrikePrice(obj.Leg1TokenNo))+(query.value("AdditionalData1").toString());
                    obj.Leg2 = (ContractDetail::getInstance().GetStrikePrice(obj.Leg2TokenNo))+(query.value("AdditionalData2").toString());
                    obj.Leg3 = (ContractDetail::getInstance().GetStrikePrice(obj.Leg4TokenNo))+(query.value("AdditionalData2").toString());
                ...
                else if (obj.Leg4TokenNo == 0)
                {
                    obj.Leg1 = (ContractDetail::getInstance().GetStrikePrice(obj.Leg1TokenNo))+(query.value("AdditionalData1").toString());
                    obj.Leg2 = (ContractDetail::getInstance().GetStrikePrice(obj.Leg2TokenNo))+(query.value("AdditionalData2").toString());
                    obj.Leg3 = (ContractDetail::getInstance().GetStrikePrice(obj.Leg3TokenNo))+(query.value("AdditionalData1").toString());
                }
                break;
            ...
            case PortfolioType::BYC_4L:
            {
                ...
                obj.Leg1 = (ContractDetail::getInstance().GetStrikePrice(leg1.TokenNumber))+(leg1.OptionType);
                obj.Leg2 = (ContractDetail::getInstance().GetStrikePrice(leg2.TokenNumber))+(leg2.OptionType);//String.Format("{0}{1}", leg2.GetStrikePrice(), leg2.OptionType);

                contract_table detail = ContractDetail::getInstance().GetDetail(obj.AdditionalData2.toInt());
                obj.Leg3 = (ContractDetail::getInstance().GetStrikePrice(detail.TokenNumber))+(detail.OptionType);
                break;
            }
            ...
            case PortfolioType::BYC_5L:
            {
                ...
                obj.Leg1 = (ContractDetail::getInstance().GetStrikePrice(leg1.TokenNumber))+(leg1.OptionType);
                obj.Leg2 = (ContractDetail::getInstance().GetStrikePrice(leg2.TokenNumber))+(leg2.OptionType);
                ...
                obj.Leg3 = QString("{0}{1}, {2}{3}")+(ContractDetail::getInstance().GetStrikePrice(detail1.TokenNumber))+(detail1.OptionType)+(ContractDetail::getInstance().GetStrikePrice(detail2.TokenNumber))+(detail2.OptionType);
                break;
            }
            case PortfolioType::BYC_6L:
            {
                ...
                obj.Leg1 = (ContractDetail::getInstance().GetStrikePrice(leg1.TokenNumber), leg1.OptionType);
                obj.Leg2 = (ContractDetail::getInstance().GetStrikePrice(leg1.TokenNumber), leg2.OptionType);

                contract_table detail1 = ContractDetail::getInstance().GetDetail(obj.AdditionalData2.toInt());
                contract_table detail2 = ContractDetail::getInstance().GetDetail(obj.AdditionalData3.toInt());
                contract_table detail3 = ContractDetail::getInstance().GetDetail(obj.AdditionalData4.toInt());
                obj.Leg3 = QString("{0}{1}, {2}{3}, {4}{5}")+(ContractDetail::getInstance().GetStrikePrice(detail1.TokenNumber)+(detail1.OptionType)+(ContractDetail::getInstance().GetStrikePrice(detail3.TokenNumber))+(detail3.OptionType));
                break;
            }
            ...
            case PortfolioType::JBX_2L:
                if (obj.Leg1TokenNo == 0)
                {
                    ...
                    {
                        //leg 1 & 2 skipped
                        obj.Leg1 = (ContractDetail::getInstance().GetStrikePrice(obj.Leg3TokenNo))+(query.value("AdditionalData1").toString());
                        obj.Leg2 = (ContractDetail::getInstance().GetStrikePrice(obj.Leg4TokenNo))+(query.value("AdditionalData2").toString());
                    }
                    else if (obj.Leg3TokenNo == 0)
                    {
                        //leg 1 & 3 skipped
                    ...
                    {
                        //leg 1 & 4 skipped
                        obj.Leg1 = (ContractDetail::getInstance().GetStrikePrice(obj.Leg2TokenNo))+(query.value("AdditionalData2").toString());//, Convert.ToString(reader["AdditionalData2"]));
                        obj.Leg2 = (ContractDetail::getInstance().GetStrikePrice(obj.Leg3TokenNo))+(query.value("AdditionalData1").toString());//, Convert.ToString(reader["AdditionalData1"]));
                    }
                }
                else if (obj.Leg2TokenNo == 0)
                {
                    ...
                    {
                        //leg 2 & 1 skipped
                        obj.Leg1 = (ContractDetail::getInstance().GetStrikePrice(obj.Leg3TokenNo))+(query.value("AdditionalData1").toString());//, Convert.ToString(reader["AdditionalData1"]));
                        obj.Leg2 = (ContractDetail::getInstance().GetStrikePrice(obj.Leg4TokenNo))+(query.value("AdditionalData2").toString());//, Convert.ToString(reader["AdditionalData2"]));
                    }
                    else if (obj.Leg3TokenNo == 0)
                    {
                        //leg 2 & 3 skipped
                        obj.Leg1 = (ContractDetail::getInstance().GetStrikePrice(obj.Leg1TokenNo))+(query.value("AdditionalData1").toString());//, Convert.ToString(reader["AdditionalData1"]));
                        obj.Leg2 = (ContractDetail::getInstance().GetStrikePrice(obj.Leg4TokenNo))+(query.value("AdditionalData2").toString());//, Convert.ToString(reader["AdditionalData2"]));
                    }
                    else if (obj.Leg4TokenNo == 0)
                    {
                ...
                else if (obj.Leg3TokenNo == 0)
                {
                    ...
                    else if (obj.Leg4TokenNo == 0)
                    {
                        //leg 3 & 4 skipped
                        obj.Leg1 = (ContractDetail::getInstance().GetStrikePrice(obj.Leg1TokenNo))+(query.value("AdditionalData1").toString());//, Convert.ToString(reader["AdditionalData1"]));
                        obj.Leg2 = (ContractDetail::getInstance().GetStrikePrice(obj.Leg2TokenNo))+(query.value("AdditionalData2").toString());//, Convert.ToString(reader["AdditionalData2"]));
                    }
                }
                else if (obj.Leg4TokenNo == 0)
                {
...
//            else
            ...
            obj.AlgoName = get_Algo_Name(obj.PortfolioTypeEnum,obj.Leg1TokenNo,obj.Leg2TokenNo,obj.Leg3TokenNo,devicer_,decimal_precision_);
...
//            StockNameLeg3.chop(2);
    ...
    void  CalculatePriceDifference(PortfolioObject &portfolio, QHash<QString, MBP_Data_Struct> MBP_Data_Hash,double devicer,int decimal_precision) {
        try {
            ...
            case PortfolioType::CR:
                return CalculateConRevPriceDifference(portfolio,MBP_Data_Hash,devicer,decimal_precision);

            case PortfolioType::BX_MKT:
            case PortfolioType::BOX:
                return CalculateBoxPriceDifference(portfolio,MBP_Data_Hash,devicer,decimal_precision);

            case PortfolioType::OPEN_BOX:
                return CalculateOpenBoxPriceDifference(portfolio,MBP_Data_Hash,devicer,decimal_precision);
    ...
    void CalculateBFLYPriceDifference(PortfolioObject &portfolio, QHash<QString, MBP_Data_Struct> MBP_Data_Hash,double devicer, int decimal_precision)
    {
    ...
    void CalculateConRevPriceDifference(PortfolioObject &portfolio, QHash<QString, MBP_Data_Struct> MBP_Data_Hash,double devicer,int decimal_precision)
    {
    ...
    void CalculateBoxPriceDifference(PortfolioObject &portfolio, QHash<QString, MBP_Data_Struct> MBP_Data_Hash, double devicer, int decimal_precision)
    {
    ...
    void CalculateOpenBoxPriceDifference(PortfolioObject &portfolio, QHash<QString, MBP_Data_Struct> MBP_Data_Hash, double devicer, int decimal_precision)
    {
