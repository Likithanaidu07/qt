...
struct qt_meta_stringdata_Table_OrderBook_Delegate_t {
    uint offsetsAndSizes[2];
    char stringdata0[25];
};
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_Table_OrderBook_Delegate_t::offsetsAndSizes) + ofs), len 
static const qt_meta_stringdata_Table_OrderBook_Delegate_t qt_meta_stringdata_Table_OrderBook_Delegate = {
    {
...
static const uint qt_meta_data_Table_OrderBook_Delegate[] = {
...
const QMetaObject Table_OrderBook_Delegate::staticMetaObject = { {
    QMetaObject::SuperData::link<QStyledItemDelegate::staticMetaObject>(),
    qt_meta_stringdata_Table_OrderBook_Delegate.offsetsAndSizes,
    qt_meta_data_Table_OrderBook_Delegate,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Table_OrderBook_Delegate_t
...
void *Table_OrderBook_Delegate::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Table_OrderBook_Delegate.stringdata0))
