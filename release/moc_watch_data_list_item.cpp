...
struct qt_meta_stringdata_watch_Data_List_Item_t {
    uint offsetsAndSizes[2];
    char stringdata0[21];
};
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_watch_Data_List_Item_t::offsetsAndSizes) + ofs), len 
static const qt_meta_stringdata_watch_Data_List_Item_t qt_meta_stringdata_watch_Data_List_Item = {
    {
...
static const uint qt_meta_data_watch_Data_List_Item[] = {
...
const QMetaObject watch_Data_List_Item::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_watch_Data_List_Item.offsetsAndSizes,
    qt_meta_data_watch_Data_List_Item,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_watch_Data_List_Item_t
...
void *watch_Data_List_Item::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_watch_Data_List_Item.stringdata0))
