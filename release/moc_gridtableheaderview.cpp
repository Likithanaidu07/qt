...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_GridTableHeaderView_t::offsetsAndSizes) + ofs), len 
...
const QMetaObject GridTableHeaderView::staticMetaObject = { {
    QMetaObject::SuperData::link<QHeaderView::staticMetaObject>(),
    qt_meta_stringdata_GridTableHeaderView.offsetsAndSizes,
    qt_meta_data_GridTableHeaderView,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_GridTableHeaderView_t
, QtPrivate::TypeAndForceComplete<GridTableHeaderView, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<int, std::false_type>, QtPrivate::TypeAndForceComplete<int, std::false_type>
