...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_GridTableView_t::offsetsAndSizes) + ofs), len 
...
const QMetaObject GridTableView::staticMetaObject = { {
    QMetaObject::SuperData::link<QTableView::staticMetaObject>(),
    qt_meta_stringdata_GridTableView.offsetsAndSizes,
    qt_meta_data_GridTableView,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_GridTableView_t
